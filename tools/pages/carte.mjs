...
export default {
  ...
  body: `${pageHero({
    ...
    <section class="section">
      <div class="container">
        <a class="map-launch" href="/carte-donnees/carte-embed.html" data-reveal>
          <span class="map-launch__media" aria-hidden="true">
            <img src="https://images.unsplash.com/photo-1502920917128-1aa500764cbd?auto=format&fit=crop&w=1400&q=70" alt="" loading="lazy">
          ...
          <span class="map-launch__body">
            ...
            <span class="map-launch__desc">Recherchez une adresse, activez les couches, comparez. La carte s'ouvre en plein écran, dans cet onglet.</span>
            <span class="btn btn--primary map-launch__btn">Vérifier une adresse ${ICON_ARROW}</span>
          </span>
        </a>
        <p class="source" style="margin-top:var(--space-3)">
